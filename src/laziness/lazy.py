...
def lazy(source: str, /, *, globals: dict[str, Any] | None = None, locals: Mapping[str, object] | None = None) -> Any:
    """
    ...
    def _hook(*_: Any) -> Any:
        return eval(source, locals=locals or frame.f_locals, globals=globals or frame.f_globals)
